...
function SnowStorm() {
  ...
  this.snowCharacter = '<img src="banana-peq.png"/>';  // &bull; = bullet, &middot; is square on some systems etc.
  ...
  this.flakeWidth = 50;            // max pixel width for snow element
  this.flakeHeight = 38;           // max pixel height for snow element
